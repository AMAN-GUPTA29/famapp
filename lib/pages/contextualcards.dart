                    ...
                    child: Column(
                      children: [
                        ...
                        hc3.isNotEmpty && hc3[0]["cards"].length != 0
                            ? HC3(
                                hc: hc3,
                                onRemindLater: handlehc3,
                                onDismissNow: handlehc3,
                              ) // in both function passing same function because we cannot permanently remove the component from the server as there is no delete api and everytime app is reloaded it will again reload it.
                            : SizedBox.shrink(),
