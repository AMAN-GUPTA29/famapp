...
class HC3 extends StatefulWidget{
   const HC3({super.key,required this.hc,required this.onRemindLater,required this.onDismissNow});
    ...
    return Container(
            ...
            child: ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  return Padding( //returning individual cards 
                        ...
                        child: Row(
                          children: [
                            ind == index && longpress==true
                                ? Container(// conditinally rendering the container with side button for remind later and dismiss now
                                  ...
                                  width: width * 0.3,
                                    child: Column(
                                      ...
                                      children: [   
                                       InkWell(
                                        onTap: (){widget.onRemindLater(index);},
                                         child: Container(padding: EdgeInsets.all(10),decoration: BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(10)) ,color: Color(0xffF7F6F3)) ,child: Column(
                                           children: [
                                             Image.asset("assets/bell.png"),
                                             SizedBox(height: 8,),
                                             Text("remind later",style: TextStyle(fontSize: 10),)
                                           ],
                                         )),
                                       ),
                                        SizedBox(height: height*0.05,),
                                       InkWell(
                                        onTap: (){widget.onDismissNow(index);},
                                         child: Container(padding: EdgeInsets.all(10),decoration: BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(10)) ,color: Color(0xffF7F6F3)) ,child: Column(
                                           children: [
                                             Image.asset("assets/cross.png"),
                                             SizedBox(height: 8,),
                                             Text("dismiss now",style: TextStyle(fontSize: 10),)
                                           ],
                                         )),
                                       ),
                            ...
                            Container(
                              width: width * 0.95,
                              child: Stack( //using stack for passing the text and everything on the image as background is in the image too
                                children: [
                                  Padding(
                                  ...
                                  Padding( // Text in hc3 component and action button to launch the website
