      ...
      child: ListView.builder(
        physics: hc6[0]["is_scrollable"] == false
          ...
          itemBuilder: (BuildContext context, int index) {
            return Padding( //returning individual cards of hc6 componet 
              padding: EdgeInsets.symmetric(vertical: height * 0.015,horizontal: width*0.01),
              child: InkWell(
                onTap: (){
                  _launchURL(hc6[0]["cards"][index]["url"]);//for launching web url
                },
                child: Container(
                  width: width * 0.915,
                  ...
                  child: Padding(
                    ...
                    child: Row( 
                      children: [
                        Image.network(hc6[0]["cards"][index]["icon"]["image_url"],height: (hc6[0]["cards"][index]["icon_size"]+height * 0.02).toDouble(),),
                        SizedBox(width: width*0.03,),
                        Text(hc6[0]["cards"][index]["formatted_title"]["entities"]
                            [0]["text"],textAlign: TextAlign.left,style: TextStyle(fontWeight: FontWeight.w600,color: Color(int.parse(
